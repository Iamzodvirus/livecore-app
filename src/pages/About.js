...
const About = () => {
  ...
  return (
    <>
      <h3 className="text-center mt-4">Meet Our Team</h3>
      ...
      <div className="d-flex justify-content-center justify-content-evenly">
        <div className="d-flex flex-column  justify-content-evenly ">
          <div className="card border-0" style={{ maxWidth: "15rem" }}>
            <img src={gideon} className="card-img-top " alt="..." />
          ...
          <div className="card border-0" style={{ maxWidth: "15rem" }}>
            <img src={peter} className="card-img-top " alt="..." />
            <div className="card-body text-center">
        ...
        <div className="d-flex flex-column  align-self-center">
          <div className="card border-0" style={{ maxWidth: "15rem" }}>
            <img src={ore} className="card-img-top " alt="..." />
            <div className="card-body text-center">
        ...
        <div className="d-flex flex-column justify-content-evenly ">
          <div className="card border-0" style={{ maxWidth: "15rem" }}>
            <img src={fasasi} className="card-img-top " alt="..." />
            <div className="card-body text-center">
          ...
          <div className="card border-0" style={{ maxWidth: "15rem" }}>
            <img src={rofiat} className="card-img-top" alt="..." />
            <div className="card-body text-center">
